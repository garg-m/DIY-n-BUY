...
import { groupedColumnsBezelInsert } from "../../partComponents/columnsBezelInsert";
...
export const TableBezelInsertInventory = () => {
    // xyz
    ...
    return (
        <div class="wrapper">
                        ...
                        page.map(row => {
                            ...
                            return (
                                <tr {...row.getRowProps()} onClick={() => {
                                    ...
                                    localStorage.setItem('selectedBezelInsert', CircularJSON.stringify(row.original))
                                }}>
                                    {
                                        row.cells.map(cell => {
            ...
            <Link to="/admin/inventory/tablebezelinsertinv">
     <button type="button">
          Add Parts!
     </button>
 </Link>
