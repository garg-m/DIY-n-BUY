...
import MOCK_DATA_BEZEL_RING from '../../mockData/MOCK_DATA_BEZEL_RING.json'
//import { groupedColumnsCase } from './columnsCase';
import { groupedColumnsBezelRing } from "../../partComponents/columnsBezelRing";
...
export const TableBezelRingInventory = () => {
    // xyz

    const [tableData, setData] = useState([]);

    useEffect(() => {
        fetch('http://localhost:3001/getAll/bezelRings/', {
            method: "GET",
            mode: 'cors',
        })
    ...
    return (
        <div class="wrapper">
            ...
            <Link to="/admin/inventory/tablebezelringinv">
     <button type="button">
          Add Parts!
     </button>
 </Link>
